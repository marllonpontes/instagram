...
import com.example.mars.instagram.helper.Permissao;
...
public class EditarPerfilActivity extends AppCompatActivity {
    ...
    private String identidicadorUsuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        identidicadorUsuario = UsuarioFirebase.getIdentificadorUsuario();
            ...
            try {
                ...
                if ( imagem != null ){
                    ...
                    StorageReference imagemRef = storageRef
                            .child("imagens")
                            .child("perfil")
                            .child( identidicadorUsuario + ".jpeg");
